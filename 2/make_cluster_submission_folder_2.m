...
sim_file_name = 'sim2';
test_number = 2;
dgp_type_vec = 1:3; %1:3
T_vec = [500 1000];

starting_sim_number = 1001; % be careful here.
total_num_sims = 9000;
...
array_batch_size = 5; % number of jobs the cluster runs at one time. (the rest go in the queue.)
